...
public class DES0									// public class DES0
{
    private String text;								// we used 4 private strings text,key,roundkeys,cipherTexts
    private String key;
    ...
    public void encrypt()								//encryption
    {
	  String cipherText = "";
      											// initial permutation
    ...
    public String expansionPermutationE(String in)								//expansionpermutationE
    {
	...
	return expandedString;											// return expanded string 
    }
	

    public String xorRoundKey(String in, String key)								// XOR round key 
    {
		String out = "";
    ...
    public String sBox(String in)											// we use 8 general s-box
    {
		...
		String[] inputSubstrings = new String[8];										// there are 8 substrings 
		int pos = 0;														// start postion = 0
    ...
    public String permutationP(String in)							// permutationP
    {
    ...
    public String inverseExpansionPermutation(String in)					// inverse Expansion permuation used for contraction from 48 down to 32 bits
    {
		int start = 1;
		int end = 5;
		String output = "";
		
		for(int i = 0; i < 8; i++)							// loop through  8 substrings 
		{
    ...
    public String initialPermutation(String in)							// initial permutation 
    {
      ...
      String permutedString = "";
      for(int i = 0; i < 64; i++)								// loop through 64 permuted strings 
      {
    ...
    public String inverseInitialPermutation(String in)						// inverse initial permutaion 
    {
      ...
      String permutedString = "";
      for(int i = 0; i < 64; i++)								// loop through 64 
      {
    ...
    public void generateKeys()							 // generate general key 
    {
      String leftHalf;
      String rightHalf;
      ...
      for(int i = 0; i < 16; i++)						// loop through 16 bits
      {
    ...
    public String permutedChoice2(String leftHalf, String rightHalf)
    {
      ...
      int[] PC2 = {14,17,11,24,1,5,3,28,15,6,21,10,23,19,12,4,26,8,16,7,27,20,13,2,
                   41,52,31,37,47,55,30,40,51,45,33,48,44,49,39,56,34,53,46,42,50,36,29,32};	//pc-2

      for(int i = 0; i < 48; i++)				  				//loop through 48 bits key
      {
    ...
    public String getCipherText(int index)			// get cipher text
    {
      return this.cipherTexts[index];				// return 
    }
